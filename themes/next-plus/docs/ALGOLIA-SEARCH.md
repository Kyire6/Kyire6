...
1. If you want to use a different version from CDN, please follow the instructions below.
    ...
    vendors:
      ...
      algolia_instant_js: https://unpkg.com/instantsearch.js@2.4.1/dist/instantsearch.js
      algolia_instant_css: https://unpkg.com/instantsearch.js@2.4.1/dist/instantsearch.min.css
      ...
    ```
